...
try{
 ...
 for(const name of ['index.html','app.js','style.css','practice.json','whale.avif','art/whalestreet-1.avif','art/wax-tub.svg','art/surfboard.svg','art/holy-brick.svg','art/captain-crown.svg']){
